...
extension String {
  ...
  ///
  /// This method is just a wrapper around swift's standard library `prefix` method, 
  /// but it ensures only positive values are accepted.
  ...
  ///
  /// This method is just a wrapper around swift's standard library `suffix` method, 
  /// but it ensures only positive values are accepted.
